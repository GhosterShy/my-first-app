...
export default function BurgerCard(props:any) {
    ...
    <div className="col">
      <div  className="card-bah  h-100 bahandi-card">
        ...
        <div className="card-body">
          <h5 className="product-title fw-bold">{props.price} ₸</h5>
          <Link style={{textDecoration:"none"}}  href={`/burgers/posts/${props.id}`}>
